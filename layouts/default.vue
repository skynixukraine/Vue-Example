			...
			<VueCookieAcceptDecline
				...
				<div slot = "message">
					<div>
						...
						<p>Wir nutzen Cookies um Ihnen eine sichere und benutzerfreundliche Website zur Verfügung zu
							stellen. Weitere Informationen finden Sie in unseren
							<a href = "/datenschutz-gmbh"> Datenschutzbestimmungen</a> oder weiter unten in den Details.
						</p>
					</div>
					<div class = "cookie__groups" v-if = "showCookieGroups">
						<dl class = "cookie__groups-list">
							...
							<dt class = "cookie__group-title"
								...
								<button class = "link--button-gradient cookie__btn-accept-all"
										@click.stop = "btnAcceptAll">Analyse Cookies akzeptieren
								</button>
								<svg class = "icon icon__small"
									 width = "20"
									 height = "20"
